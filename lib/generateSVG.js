...
// uncomment to run from this file for testing purposes and remove one of the . in the ""../example" in the writeFile function because we're running in different directories
//generateSVG();
